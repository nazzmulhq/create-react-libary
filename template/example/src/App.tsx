	...
	return (
		<div className={`app ${darkMode.value ? "dark" : ""}`}>
			<header className="header">
				<h1>🎉 Example App</h1>
				<p>
					This app uses <code>my-react-library</code> just like your users will!
				</p>
			...
			<main className="main">
				...
				<section className="section">
					...
					<div className="card-grid">
						<Card variant="elevated" hoverable>
							...
							<CardContent>
								<p>
									This is an elevated card with shadow. Try editing the library
									code!
								</p>
							</CardContent>
							<CardFooter>
				...
				<section className="section">
					...
					<Card variant="outlined">
						<CardContent>
							<p>
								Dark mode state: <strong>{darkMode.value ? "ON" : "OFF"}</strong>
							</p>
							<div className="button-row" style={{ marginTop: "1rem" }}>
								<Button size="sm" onClick={darkMode.toggle}>
									Toggle
								</Button>
								<Button size="sm" variant="outline" onClick={darkMode.setTrue}>
									ON
								</Button>
								<Button size="sm" variant="outline" onClick={darkMode.setFalse}>
									OFF
								</Button>
							</div>
						</CardContent>
			...
			<footer className="footer">
				<p>
					Edit library in <code>lib/</code> → changes rebuild automatically → refresh this
					page!
				</p>
			</footer>
		</div>
